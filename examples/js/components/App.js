...
import '../../../css/oton-bootstrap-table.css';
import {
  Grid,
  Row,
  Col
        ...
        <nav className='navbar navbar-inverse'>
          <div className='container-fluid'>
            <div className='navbar-header'>
              <a className='navbar-brand' href='#'>oton-bootstrap-table</a>
            </div>
            <div className='collapse navbar-collapse'>
              <ul className='nav navbar-nav'>
                ...
                <li>
                  <a href='https://github.com/AllenFang/oton-bootstrap-table'>Github</a>
                </li>
